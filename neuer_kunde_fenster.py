...
def neuer_kunde_popup(root):
    ...
    stadt_label.grid(row=13, column=1, sticky="w", padx=5)
    ...
    telefon_label.grid(row=0, column=0, pady=5, padx=10, sticky="w")
    ...
    newsletter_checkbox.grid(row=6, column=0, pady=(20, 4))
